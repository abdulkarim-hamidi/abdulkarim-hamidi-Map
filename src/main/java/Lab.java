 ...
 * Maps are key/value pairs. They are used in situations where we have some 
 value that we'd like
 * to efficiently be able to access, but can be easily identified by some other
 *  value.
 ...
 *
 * You can read more about HashMap, a very efficient implementation of Map, 
 * here:
...
public class Lab {
     ...
     * like
     * TreeSet or HashSet. This will be a Map that maps Integer keys to String 
     * values.
     * For example, 1:cat, 2:dog, 3:rat, etc.
     *
     * @return a new Map instantiated using Integer keys and String values.
     * Like the other collections problems, Map alone is only an interface.
     *  Some common Map implementations are
     * HashMap and TreeMap. Also like the other collections, Map must leverage
     *  a wrapper class instead of a primitive,
     * so here Integer is a wrapper for int.
     */
    public Map<Integer, String> createMap(){
        Map<Integer, String> createMap1 = new HashMap<>();
        return createMap1;
    }
...
//        return total number of key/value pairs in the map
     ...
     * @return nothing, pass by reference will cause changes to the 
     * list object to be reflected across the program.
     */
